      ...
      <div className="container mx-auto px-4 lg:px-8 py-12 relative pt-24">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat) => (
              <div key={stat.label} className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-xl hover:bg-white/[0.04] transition-all space-y-4">
            ...
            <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-xl">
              ...
              <div className="space-y-4">
                {topCategories.map((category, index) => (
                  <div key={category.name} className="flex items-center justify-between group hover:translate-x-2 transition-transform">
                ...
                {topMarketplaces.map((marketplace) => (
                  <div key={marketplace.name} className="space-y-2">
                    ...
                    <div className="h-2.5 rounded-full bg-white/[0.03] overflow-hidden">
                      <div
                        className={`h-full rounded-full bg-gradient-to-r ${marketplace.color} transition-all duration-1000`}
          ...
          <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-xl">
            ...
            <div className="space-y-1">
              {recentActivity.map((activity, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between py-4 border-b border-white/[0.03] last:border-0 group hover:bg-white/[0.02] px-4 -mx-4 rounded-lg transition-colors"
                >
                  <div>
