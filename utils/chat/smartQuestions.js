...
export function detectProvidedInfo(query) {
    ...
    for (const pattern of storagePatterns) {
        ...
        if (match) {
            ...
            if (size === 64)
                provided.storage = '64GB';
            else if (size === 128)
                provided.storage = '128GB';
            else if (size === 256)
                provided.storage = '256GB';
            else if (size === 512)
                provided.storage = '512GB';
            else if (size === 1024 || size === 1)
                provided.storage = '1TB';
