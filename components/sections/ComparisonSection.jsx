    ...
    return (<section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="max-w-5xl mx-auto space-y-6 mb-12">
          {comparisons.map((item, i) => (<motion.div key={i} className="grid md:grid-cols-[1fr_auto_1fr] gap-4 items-center" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
              {/* Old Way */}
        ...
        <motion.div className="text-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <Link href="/auth">
            <motion.button className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-bold text-lg shadow-lg shadow-blue-500/25 overflow-hidden" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
