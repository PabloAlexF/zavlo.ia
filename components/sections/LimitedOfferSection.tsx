    ...
    >
      <div className="max-w-4xl mx-auto bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-3xl p-8 sm:p-12 text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          {['Busca ilimitada', 'IA avançada', 'Sem cartão'].map((feature) => (
            <div key={feature} className="flex items-center justify-center gap-2 text-gray-300">
        ...
        <Link href="/auth">
          <motion.button 
            className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-purple-500/50 transition-all inline-flex items-center gap-2"
