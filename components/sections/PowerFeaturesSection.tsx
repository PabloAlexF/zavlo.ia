...
export default function PowerFeaturesSection() {
  ...
  return (
    <AnimatedSection className="py-20 bg-gradient-to-b from-transparent to-blue-500/5">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {features.map((feature, i) => (
            <div
              key={i}
              className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-xl hover:bg-white/10 transition-all group"
            >
