...
export default function SearchResults({ results, loading, onFavorite }: SearchResultsProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {results.map((product) => (
          <div
            key={product.id}
            className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-200 group"
          >
            <div className="flex gap-4">
