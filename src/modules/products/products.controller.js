...
import { Controller, Get, Post, Delete, UseGuards, NotFoundException } from '@nestjs/common';
import { JwtAuthGuard } from '../auth/guards/jwt-auth.guard';
let ProductsController = (() => {
    let _classDecorators = [Controller('products')];
    ...
    (() => {
        ...
        _remove_decorators = [Delete(':id'), UseGuards(JwtAuthGuard)];
