...
export default function About() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0B0B0F] text-white">
      ...
      <div 
        className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-[100px] animate-pulse mix-blend-screen transition-transform duration-500 ease-out"
        style={{ transform: `translate(${mousePos.x * -20}px, ${mousePos.y * -20}px)` }}
      />
      <div 
        className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-[100px] animate-pulse mix-blend-screen transition-transform duration-500 ease-out"
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 py-24 sm:py-32 space-y-24">
        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <div key={feature.title} className="relative bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 group">
        ...
        <div className="text-center p-10 sm:p-12 rounded-2xl bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 border border-white/10">
          ...
          <a
            href="mailto:contato@zavlo.ia"
            className="inline-block px-8 py-3 rounded-full bg-white/10 backdrop-blur-sm text-white font-semibold border-2 border-white/30 hover:bg-white/20 hover:scale-105 transition-all duration-300"
          >
            contato@zavlo.ia
          </a>
        </div>
