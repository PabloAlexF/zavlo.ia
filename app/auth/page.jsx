...
export default function Auth() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const userData = Object.assign(Object.assign({}, data.data), { token: data.data.accessToken });
      ...
      <div className="relative z-10 w-full max-w-md mx-auto pt-32 pb-12 px-4">
        ...
        <div className="bg-white/5 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border border-white/10 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {message && (<div className={`p-4 rounded-xl text-sm font-medium flex items-center gap-2 ${message.type === 'success'
            ...
            {!isLogin && (<div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/20 focus:border-blue-500 focus:bg-white/10 outline-none transition text-white placeholder-gray-500" placeholder="Seu nome" required={!isLogin}/>
                </div>
              </div>)}
            ...
            {!isLogin && (<div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={cep} onChange={(e) => handleCepChange(e.target.value)} maxLength={9} className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/20 focus:border-blue-500 focus:bg-white/10 outline-none transition text-white placeholder-gray-500" placeholder="00000-000" required={!isLogin}/>
                </div>
                {city && state && (<p className="text-xs text-green-400 mt-2 font-medium flex items-center gap-1">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/20 focus:border-blue-500 focus:bg-white/10 outline-none transition text-white placeholder-gray-500" placeholder="seu@email.com" required/>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} className="w-full pl-12 pr-12 py-3 rounded-xl bg-white/5 border border-white/20 focus:border-blue-500 focus:bg-white/10 outline-none transition text-white placeholder-gray-500" placeholder="••••••••" minLength={6} required/>
            ...
            <button type="submit" disabled={loading} className="w-full px-6 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold hover:from-blue-700 hover:to-purple-700 transition shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed">
