...
export default function ComparePage() {
    ...
    const handleCompare = async () => {
        setLoading(true);
        try {
            const response = await fetch(`${API_URL}/comparisons/compare?title=${productName}`);
    ...
    return (<div className="min-h-screen bg-[#0B0B0F]">
      ...
      <div className="relative container mx-auto px-4 py-12 pt-24 sm:pt-28">
        ...
        <div className="max-w-2xl mx-auto mb-8 sm:mb-12">
          <div className="relative group">
            ...
            <div className="relative flex flex-col sm:flex-row gap-3 sm:gap-4 bg-[#0B0B0F] border border-white/20 rounded-2xl p-4 sm:p-6">
              <input type="text" value={productName} onChange={(e) => setProductName(e.target.value)} placeholder="Ex: iPhone 13 Pro Max" className="flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 outline-none focus:border-blue-500 transition-colors"/>
              <button onClick={handleCompare} disabled={loading || !productName} className="px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl font-medium hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap">
        ...
        {comparison && (<div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white/5 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-8">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
                <div className="text-center p-3 sm:p-6 bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/20 rounded-xl sm:rounded-2xl">
                  ...
                  <div className="text-xl sm:text-3xl font-bold text-green-400">
                    R$ {(_a = comparison.minPrice) === null || _a === void 0 ? void 0 : _a.toFixed(2)}
                  </div>
                </div>
                ...
                <div className="text-center p-3 sm:p-6 bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/20 rounded-xl sm:rounded-2xl">
                  ...
                  <div className="text-xl sm:text-3xl font-bold text-blue-400">
                    R$ {(_b = comparison.averagePrice) === null || _b === void 0 ? void 0 : _b.toFixed(2)}
                  </div>
                </div>
                ...
                <div className="text-center p-3 sm:p-6 bg-gradient-to-br from-red-500/10 to-red-500/5 border border-red-500/20 rounded-xl sm:rounded-2xl">
                  ...
                  <div className="text-xl sm:text-3xl font-bold text-red-400">
                    R$ {(_c = comparison.maxPrice) === null || _c === void 0 ? void 0 : _c.toFixed(2)}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {(_d = comparison.sources) === null || _d === void 0 ? void 0 : _d.map((source, index) => (<div key={index} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors gap-3">
