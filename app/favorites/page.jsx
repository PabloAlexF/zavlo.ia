                ...
                if (response.ok) {
                    ...
                    if (response.ok) {
                        ...
                        favoritesData.push({
                            ...
                            productImage: (_b = listing.images) === null || _b === void 0 ? void 0 : _b[0],
    ...
    return (<div className="min-h-screen bg-[#0B0B0F]">
      ...
      <main className="max-w-4xl mx-auto px-4 pt-24 pb-12">
        ...
        {favorites.length === 0 ? (<div className="text-center py-12">
            ...
            <button onClick={() => router.push('/')} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
              Buscar Produtos
            </button>
          </div>) : (<div className="space-y-4">
            {favorites.map((favorite) => (<div key={favorite.id} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-200">
                <div className="flex gap-4">
                  <div className="relative w-20 h-20 flex-shrink-0">
                    {favorite.productImage ? (<Image src={favorite.productImage} alt={favorite.productTitle} fill className="object-cover rounded-lg" onError={(e) => {
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button onClick={() => removeFavorite(favorite.id)} className="p-2 rounded-lg bg-red-500/20 text-red-400 hover:bg-red-500/30 transition-colors">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                          </svg>
                        </button>
                        
                        <a href={favorite.productUrl} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                          Ver Produto
                        </a>
                      </div>
                    </div>
